 ...
 *  Execution:    java RedBlackBSTReference < input.txt
 ...
 *
 *  % java RedBlackBSTReference < tinyST.txt
 *  A 8
 *  C 4
 *  E 12
 *  H 5
...
public class RedBlackBSTReference<Key extends Comparable<Key>, Value> {
    ...
    /**
     * Unit tests the {@code RedBlackBSTReference} data type.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args) {
        RedBlackBSTReference<String, Integer> st = new RedBlackBSTReference<String, Integer>();
